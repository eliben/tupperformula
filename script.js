...
Flipx.addEventListener("change", onNumChange);
const Flipy = document.querySelector("#flipy");
Flipy.addEventListener("change", onNumChange);
...
function onNumChange() {
    console.log(Flipx.checked, Flipy.checked);
    try {
